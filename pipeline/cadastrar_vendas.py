...
BICICLETAS_NOVAS = [
    ...
    # estoque fantasma. E o exemplo de por que duas fontes concordando nao bastam
...
CONSIGNACOES_NOVAS = [
    ...
    ['624', '117', '', '87', 'Bicicleta', 'Bicicleta MTB Cannondale F-Si carbon 4',
     'Cliente 087', '11900', '', 'Vendido', '15/06/2025', '15/07/2026',
    ...
    ['625', '223', '', '20', 'Bicicleta', 'Bicicleta para triathlon #felt IA FRD 2.0 Ultimate',
     'Cliente 020', '60000', '', 'Vendido', '01/08/2026', '25/08/2026',
    ...
    # mais proxima em valor (#194) faz parte do trio #192/#193/#194, a
    # mesma bike fisica contada tres vezes.
    # Vale o preco CHEIO, nao o promocional: o anuncio do site traz os dois
    # ("De" e "Por"), e o Excel registra o cheio em todas as abas de jan a set.
    ...
    ['626', '343', '', '105', 'Bicicleta', 'Bicicleta Specialized Roubaix Carbono SRAM Apex',
     'Cliente 105', '7500', 'Física', 'Em estoque', '', '',
