...
pintada. Em agosto/2026, 2 das 21 linhas vermelhas eram retiradas (valor).
...
EXCEL_PADRAO = os.getenv('EXCEL_LOJA', 'Cadastro de clientes 2026.xlsx')
...
# Em janeiro/2026 inflaram o mes com receita que nao existia.
ROTULOS = re.compile(
