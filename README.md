...
Antes de entregar qualquer análise, a base passou por auditoria. Um teste barato revelou o achado que mudou o escopo do trabalho: distribuir a receita pelo **dia do mês** da data de saída.

Venda real não se concentra no dia 1, 30 ou 31 — mas ali, dois terços de toda a receita histórica caíam exatamente nesses dias. Não era erro de cálculo: eram datas-marcador, preenchidas em lote quando as doze planilhas antigas foram consolidadas em uma. O corte é nítido: até março de 2026, entre 63% e 100% da receita de cada mês cai em borda; de abril em diante, entre 0% e 29%, e cada caso remanescente tem confirmação documental.

A consequência é que faturamento mensal, giro e sazonalidade anteriores a abril de 2026 são artefato. A análise entregue recortou a janela e declarou isso explicitamente, e a regra virou a coluna `confiavel` no banco — assim o aviso viaja junto com o número, em vez de depender de alguém lembrar.
