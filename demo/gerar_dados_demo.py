...
O que muda e o que fica:
  ...
  VALOR  -> reduzido e embaralhado. Preserva a forma da distribuição (ticket
      médio, faixas de comissão, a cauda de bikes caras) sem expor o
      faturamento real, que é informação do negócio do cliente.
      Os parâmetros dessa transformação vêm do .env e não são versionados:
      publicados, permitiriam desfazê-la. Veja o bloco abaixo.
...
#
#   DEMO_SEMENTE   inteiro; fixa o embaralhamento para ser reproduzível
#   DEMO_ESCALA    fator entre 0 e 1 que reduz o porte do negócio
#   DEMO_VARIACAO  ruído por item, que desfaz a proporção entre eles
